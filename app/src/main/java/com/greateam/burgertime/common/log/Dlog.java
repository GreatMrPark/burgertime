package com.greateam.burgertime.common.log;

import android.util.Log;

import com.greateam.burgertime.BaseApplication;

public class Dlog {

    static final String TAG = "BURGERTIME";
    ...
    public static final void d(String message) {
        System.out.println("BaseApplication.DEBUG : " + BaseApplication.DEBUG);
